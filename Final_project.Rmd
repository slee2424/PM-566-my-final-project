...
```{r, eval=FALSE}
best_outcome_model0 <- glm(outcome ~ dpf + lip + glu + ins + bmi + age, family=binomial, data=db_train) 
summary(best_outcome_model0)
...
summary(subset_outcome_prelim2)
...
best_outcome_model <- glm(outcome ~ dpf + lip + glu + ins + bmi + ins*dpf, family=binomial, data=db_train) 
